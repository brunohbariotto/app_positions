    ...
    def fundamentos(self):
        ...
        if tipo == 'Ações':
            ...
            if radio == 'Empresas':
                ...
                st.write(filter_df)
                st.write(filter_df.groupby('TICKER')['P/EBIT'].rank(method='max'))
                st.write(filter_df('TICKER')['DY'].rank(method='min'))
                st.write(filter_df('TICKER')['P/L'].rank(method='max'))
                st.write(filter_df('TICKER')['P/VP'].rank(method='max'))
                st.write(filter_df('TICKER')['P/ATIVOS'].rank(method='max'))
