    ...
    def fundamentos(self):
        ...
        if tipo == 'Ações':
            ...
            if radio == 'Empresas':
                ...
                st.write(filter_df)
                st.write(filter_df.groupby('TICKER')['P/EBIT'].rank(ascending=False))
                st.write(filter_df('TICKER')['DY'].rank(ascending=True))
                st.write(filter_df('TICKER')['P/L'].rank(ascending=False))
                st.write(filter_df('TICKER')['P/VP'].rank(ascending=False))
                st.write(filter_df('TICKER')['P/ATIVOS'].rank(ascending=False))
